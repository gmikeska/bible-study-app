...
class BibleApi < ApiGears
  def initialize(**options)
    ...
    endpoint "sections", path:"/bibles/{bible_id}/sections/{section_id}"
    endpoint "book_sections", path:"/bibles/{bible_id}/books/{book_id}/sections"
    endpoint "chapter_sections", path:"/bibles/{bible_id}/chapters/{chapter_id}/sections"
